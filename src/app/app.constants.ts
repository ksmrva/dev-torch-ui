export const APP_LOGO_PATH: string = "assets/images/icons/torch/torch-logo-white2.png";

export const PRIMARY_KEY_ICON_PATH: string = "assets/images/icons/db/primary-key-icon.png";
export const FOREIGN_KEY_ICON_PATH: string = "assets/images/icons/db/foreign-key-icon2.png";
export const ONE_AND_ONLY_ONE_RELATIONSHIP_ERD_ARROWHEAD_ICON_PATH: string = "assets/images/icons/erd/arrowheads/one-and-only-one.png";
