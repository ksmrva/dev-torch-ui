...
export class SqlForeignKeyDetail extends ApiEntity {
  ...
  override deserialize(json: any): SqlForeignKeyDetail {
  ...
  override isEqualTo(otherEntity: SqlForeignKeyDetail): boolean {
