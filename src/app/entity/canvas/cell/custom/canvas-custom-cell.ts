...
export class CanvasCustomCell extends CanvasCell {
  ...
  static initializeJointCustomValues(
    ...
    JointModelValueAccessor.initializeValue( CELL_HTML_JOINT_KEY, html, jointCell );
    JointModelValueAccessor.initializeValue( CELL_LINKS_JOINT_KEY, cellLinks, jointCell );
    JointModelValueAccessor.initializeValue( LINKED_CELLS_JOINT_KEY, linkedCells, jointCell );
    JointModelValueAccessor.initializeValue( RELATIVE_POSITION_TO_OTHER_CELLS_JOINT_KEY, linkedCellsRelativePosition, jointCell );
  }

  // Get Initial Joint Values
  static getInitialJointCellHtml(jointCell: dia.Cell): string {
    return JointModelValueAccessor.getInitialValue( CELL_HTML_JOINT_KEY, jointCell );
  }
  static getInitialJointCellLinks(jointCell: dia.Cell): shapes.standard.Link[] {
    return JointModelValueAccessor.getInitialValue( CELL_LINKS_JOINT_KEY, jointCell );
  }
  static getInitialJointLinkedCells( jointCell: dia.Cell ): Map<string, dia.Cell> {
    return JointModelValueAccessor.getInitialValue( LINKED_CELLS_JOINT_KEY, jointCell );
  }
  static getInitialJointRelativePositionToOtherCells( jointCell: dia.Cell ): Map<string, string> {
    return JointModelValueAccessor.getInitialValue( RELATIVE_POSITION_TO_OTHER_CELLS_JOINT_KEY, jointCell );
  }

  // Get Current Joint Values
  static getCurrentJointCellHtml(jointCell: dia.Cell): string {
    return JointModelValueAccessor.getCurrentValue( CELL_HTML_JOINT_KEY, jointCell );
  }
  static getCurrentJointCellLinks(jointCell: dia.Cell): shapes.standard.Link[] {
    return JointModelValueAccessor.getCurrentValue( CELL_LINKS_JOINT_KEY, jointCell );
  }
  static getCurrentJointLinkedCells( jointCell: dia.Cell ): Map<string, dia.Cell> {
    return JointModelValueAccessor.getCurrentValue( LINKED_CELLS_JOINT_KEY, jointCell );
  }
  static getCurrentJointRelativePositionToOtherCells( jointCell: dia.Cell ): Map<string, string> {
    return JointModelValueAccessor.getCurrentValue( RELATIVE_POSITION_TO_OTHER_CELLS_JOINT_KEY, jointCell );
  }

  // Set Joint Values
  static setJointCellHtml(html: string, jointCell: dia.Cell): void {
    return JointModelValueAccessor.setCurrentValue( CELL_HTML_JOINT_KEY, html, jointCell );
  }
