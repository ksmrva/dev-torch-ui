...
export class CanvasViewerComponent extends BaseComponent implements OnInit {
  ...
  addCellsFromDbModel(dbModelName: DatabasePath): void {
    if (this.currentJointJsGraph) {
      this.dbModelService.getDatabase(dbModelName).subscribe({
                                                            next: (dbModel: DbModel | undefined) => {
                                                              if (!dbModel) {
                                                                throw new Error( "Failed to get the Database Model using Name [" + dbModelName.getFullPath() + "]" );
                                                              }
                                                              if (!this.loadedCanvas) {
                                                            ...
                                                            error: (err: any) => {
                                                              throw new Error( "Failed to get the Database Model using Name [" + dbModelName.getFullPath() + "] due to [" + err + "]" );
                                                            },
                                                            complete: () => {
