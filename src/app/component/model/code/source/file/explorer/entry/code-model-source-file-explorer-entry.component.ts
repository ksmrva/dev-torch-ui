...
@Component({
  selector: 'code-model-source-file-explorer-entry',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule
  ],
  templateUrl: './code-model-source-file-explorer-entry.component.html',
  styleUrl: './code-model-source-file-explorer-entry.component.scss'
})
export class CodeModelSourceFileExplorerEntryComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    this.baseHtmlId = "codeModelSourceFileExplorer_Entry";
