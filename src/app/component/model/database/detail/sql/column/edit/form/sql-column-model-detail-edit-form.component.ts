...
@Component({
  selector: "sql-column-model-detail-edit-form",
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: "./sql-column-model-detail-edit-form.component.html",
  styleUrl: "./sql-column-model-detail-edit-form.component.scss"
})
export class SqlColumnModelDetailEditFormComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    this.columnEditForm = formBuilder.group({
