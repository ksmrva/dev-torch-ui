...
import { SqlColumnModelDetailEditFormComponent } from "../form/sql-column-model-detail-edit-form.component";

@Component({
  selector: "sql-column-model-detail-editor",
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    SqlColumnModelDetailEditFormComponent,
    SimpleMenuSelectComponent
],
  templateUrl: "./sql-column-model-detail-editor.component.html",
  styleUrl: "./sql-column-model-detail-editor.component.scss"
})
export class SqlColumnModelDetailEditorComponent extends BaseComponent implements OnInit {
