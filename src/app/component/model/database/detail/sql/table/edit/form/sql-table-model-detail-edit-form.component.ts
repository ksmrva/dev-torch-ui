...
import { SqlColumnModelDetailEditorComponent } from "../../../column/edit/editor/sql-column-model-detail-editor.component";
import { SqlModelDetailService } from "../../../../../../../../service/model/database/detail/sql/sql-model-detail.service";

@Component({
  selector: "sql-table-model-detail-edit-form",
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    SqlColumnModelDetailEditorComponent
  ],
  templateUrl: "./sql-table-model-detail-edit-form.component.html",
  styleUrl: "./sql-table-model-detail-edit-form.component.scss"
})
export class SqlTableModelDetailEditFormComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    this.tableEditForm = formBuilder.group({
