...
import { SqlTableDetailEditFormComponent } from "../form/sql-table-detail-edit-form.component";
import { SimpleEditSelectComponent } from "../../../../../../../shared/edit/select/simple/simple-edit-select.component";

@Component({
  selector: "sql-table-detail-editor",
  standalone: true,
  imports: [
    CommonModule,
    SqlTableDetailEditFormComponent,
    SimpleEditSelectComponent
],
  templateUrl: "./sql-table-detail-editor.component.html",
  styleUrl: "./sql-table-detail-editor.component.scss"
})
export class SqlTableDetailEditorComponent extends BaseComponent implements OnInit {
